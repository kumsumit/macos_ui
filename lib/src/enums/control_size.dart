...
/// size, but a [MacosSwitch] supports mini, small, and regular sizes. In cases
/// where a control doesn't support a certain size, the control will
/// automatically fall back to the nearest supported size.
///
/// Reference:
...
enum ControlSize {
  ...
  /// A control that emphasizes a primary action in a spacious layout.
  extraLarge,
}
